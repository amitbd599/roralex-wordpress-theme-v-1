         ...
         <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
            ...
            <div class="error__item text-center">
               <div class="error__thumb mb-45">
                  <img src="<?php echo esc_url($roralex_404_bg); ?>" alt="<?php print esc_attr__('Error 404','roralex'); ?>">
               </div>
               <div class="error__content">
                  <h3 class="error__title"><?php print esc_html($roralex_error_title);?></h3>
                  <p><?php print esc_html($roralex_error_desc);?></p>
                  <a href="<?php print esc_url(home_url('/'));?>" class="tp-btn"><?php print esc_html($roralex_error_link_text);?></a>
               </div>
            </div>
         </div>
      </div>
