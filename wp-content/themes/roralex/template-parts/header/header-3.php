               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-6 d-none d-lg-block">
                  <div class="header__call d-flex align-items-start">
                     ...
                     <div class="header__call-content">
                        ...
                        <h4><a href="tel:<?php echo esc_attr($roralex_phone_num); ?>"><?php echo esc_html($roralex_phone_num); ?></a></h4>
                        <?php endif; ?>
                        <?php if ( !empty( $roralex_mail_id ) ): ?>
                        <p><a href="mailto:<?php echo esc_attr($roralex_mail_id); ?>"><?php echo esc_html($roralex_mail_id); ?></a></p>
                        <?php endif; ?>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-8 col-6">
                  <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                     <div class="header__lang d-none d-md-block">
                        <?php roralex_header_lang_defualt(); ?>
                     </div>

                     <?php if ( !empty( $roralex_acc_button_link ) ): ?>
                     <div class="header__login-2 d-none d-md-flex align-items-center ml-20 pl-20">
                        ...
                        <div class="header__login-content">
                           <p><a href="<?php echo esc_html($roralex_acc_button_link); ?>"><?php echo esc_html__('Login','roralex'); ?></a></p>
                           <p><a href="<?php echo esc_html($roralex_acc_button_link); ?>"><?php echo esc_html__('Register','roralex'); ?></a></p>
                        </div>
                     </div>
                     <?php endif; ?>
            ...
            <div class="col-xxl-4 col-xl-3 col-lg-2 col-md-6 col-6">
               <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                  ...
                  <div class="header__action d-none d-xl-block">
                     <ul>
                        <li>
                           <a href="<?php echo esc_html($roralex_acc_button_link); ?>">
