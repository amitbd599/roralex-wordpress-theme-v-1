          ...
          <div class="row align-items-center">
             <div class="col-xxl-6 col-xl-8 col-lg-8 col-md-8">
                <div class="header__info">
                   <ul>
                   	<?php if ( !empty( $roralex_mail_id ) ): ?>
                      <li>
                         <a href="mailto:<?php echo esc_attr($roralex_mail_id); ?>">
                            ...
                            </svg> <?php echo esc_html($roralex_mail_id); ?></a>
                      </li>
                    <?php endif; ?>
                    <?php if ( !empty( $roralex_address ) ): ?>
                      <li>
                         <a href="<?php echo esc_html($roralex_address_url); ?>" target="_blank">
                            ...
                            <?php echo esc_html($roralex_address); ?></a>
                      </li>
                      <?php endif; ?>
                   </ul>
                </div>
             ...
             <div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
                <div class="header__top-right d-flex justify-content-end align-items-center">
                	<?php if ( !empty( $roralex_acc_button_text ) ): ?>
                    <div class="header__login">
                      <a href="<?php echo esc_html($roralex_acc_button_link); ?>"><svg viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         </svg> <?php echo esc_html($roralex_acc_button_text); ?></a>
                    </div>
                	<?php endif; ?>

                    <?php if ( !empty( $roralex_button_text ) ): ?>
                    <div class="header__btn ml-20">
                    	<a href="<?php echo esc_html($roralex_button_link); ?>" class="header-btn"><?php echo esc_html($roralex_button_text); ?></a>
                    </div>
                    <?php endif; ?>
                   ...
                   <div class="header__search w-100 d-none d-xl-block">
                      <form action="<?php print esc_url( home_url( '/' ) );?>">
                         <div class="header__search-input">
                            <input type="text" name="s" value="<?php print esc_attr( get_search_query() )?>" placeholder="<?php print esc_attr__( 'Search...', 'roralex' );?>">
