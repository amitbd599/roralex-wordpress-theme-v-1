<?php
    ...
    $author_info = get_the_author_meta( 'roralex_write_by');
    $facebook_url = get_the_author_meta( 'roralex_facebook' );
    $twitter_url = get_the_author_meta( 'roralex_twitter' );
    $linkedin_url = get_the_author_meta( 'roralex_linkedin' );
    $instagram_url = get_the_author_meta( 'roralex_instagram' );
    $roralex_url = get_the_author_meta( 'roralex_youtube' );
    $roralex_write_by = get_the_author_meta( 'roralex_write_by' );
